...
<html>
    ...
    <body>
            ...
            <br><br>
            <hr>
      <div style ="float: right; margin-right: 100px; margin-top: 100px; border-style: solid; border-width: 1px; border-radius: 5px; border-color: grey; ">
